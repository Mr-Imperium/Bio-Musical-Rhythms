...
with tab2:
    ...
    **Time-Domain Autocorrelation for Structural Entrainment**
    ...
    st.subheader("Structural Analysis Controls")
    
    col_upload, col_speed = st.columns([2, 1])

    with col_upload:
        uploaded_file_tab2 = st.file_uploader("Upload Audio for Structural Analysis (.wav, .mp3)", type=["wav", "mp3"])
    ...
    if uploaded_file_tab2:
        ...
        st.warning("Please upload an audio file above to begin the structural analysis.")
